...
module log_div (
    ...
    // Tim s1, s2.
    reg borrow_1_old, borrow_2_old;
    reg [3:0] s1_old, s2_old;
    RBS # (
        .WIDTH(4)
    ) sub_s1 (
        .a(4'b0010),
    ...
    always @ (posedge CLK, posedge RST) begin
        if (RST) begin
            ...
            u1_old <= F1[13:0] << control_1;
            u2_old <= F2[13:0] << control_2;
        end
    end
    ...
    // tinh delta_s, delta_u va Delta.
    reg [18:0] delta_s, delta_u;
    RBS # (
        .WIDTH(19)
    ) sub_s (
        .a(s1),
